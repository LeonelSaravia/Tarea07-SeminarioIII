    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?= base_url('/usuario/actualizar/' . $usuario_edit['id']) ?>" method="post">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="nivelacceso" name="nivelacceso">
                                        <option value="USER" <?= $usuario_edit['nivelacceso'] == 'USER' ? 'selected' : '' ?>>Usuario</option>
                                        <option value="ADMIN" <?= $usuario_edit['nivelacceso'] == 'ADMIN' ? 'selected' : '' ?>>Administrador</option>
                                    </select>
                                </div>
                            </div>
                        </div>
